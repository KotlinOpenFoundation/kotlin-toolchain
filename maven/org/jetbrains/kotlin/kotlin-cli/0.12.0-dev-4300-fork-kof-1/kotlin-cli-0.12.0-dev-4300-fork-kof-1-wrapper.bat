...
@rem                              default: https://kotlinopenfoundation.github.io/kotlin-toolchain/maven
...
set kotlin_cli_version=0.12.0-dev-4300-fork-kof-1
@rem Establish chain of trust from here by specifying the exact checksum of the Kotlin Toolchain distribution to be run
set kotlin_cli_sha256=1b4df8ba35b1d1e7feebf530e24d2eebd0b1e4be12d93aaf035f66903217f1ff

if not defined KOTLIN_CLI_DOWNLOAD_ROOT set KOTLIN_CLI_DOWNLOAD_ROOT=https://kotlinopenfoundation.github.io/kotlin-toolchain/maven
...
set kotlin_cli_url=https://github.com/KotlinOpenFoundation/kotlin-toolchain/releases/download/v0.12.0-dev-4300-fork-kof-1/kotlin-cli-0.12.0-dev-4300-fork-kof-1-dist.tgz
