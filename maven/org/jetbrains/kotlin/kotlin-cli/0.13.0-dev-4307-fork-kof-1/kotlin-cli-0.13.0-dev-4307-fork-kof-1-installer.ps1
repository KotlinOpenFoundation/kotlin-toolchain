...
$KotlinCliVersion = '0.13.0-dev-4307-fork-kof-1'
$KotlinCliWrapperSha256 = 'e9bb48254dc3b4e67d79774f89cda4719bcae79872af8500787a11ba3502b83b'

if ($env:KOTLIN_CLI_DOWNLOAD_ROOT) {
    $KotlinCliDownloadRoot = $env:KOTLIN_CLI_DOWNLOAD_ROOT.TrimEnd('/')
}
else {
    $KotlinCliDownloadRoot = 'https://kotlinopenfoundation.github.io/kotlin-toolchain/maven'
}
