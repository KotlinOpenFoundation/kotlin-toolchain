...
set kotlin_cli_version=0.13.0-dev-4307-fork-kof-1
@rem Establish chain of trust from here by specifying the exact checksum of the Kotlin Toolchain distribution to be run
set kotlin_cli_sha256=2220c7fdc89a7e8ac46000ba84919715cd6eec0d6efd796629d7c471feab6b48
...
set kotlin_cli_url=https://github.com/KotlinOpenFoundation/kotlin-toolchain/releases/download/v0.13.0-dev-4307-fork-kof-1/kotlin-cli-0.13.0-dev-4307-fork-kof-1-dist.tgz
